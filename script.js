...
function fillCatalog(desserts) {
  const html = desserts.map((dessert) => {
    return `
    <div id="${formatId(dessert.name)}" class="dessert relative space-y-6">
  ...
  if(Object.keys(cart).length === 0) {
          ...
          <div class="space-y-1">
            ...
            <div class="flex gap-4">
              ...
              <div class="flex gap-2 text-sm">
                <p class="text-(--rose400)"><span class="text-xs">@</span>$${desserts[dessertId].price}</p>
    ...
    `
      ...
      <div class="flex justify-between items-center">
        ...
        <p class="text-3xl font-bold text-(--rose900)">$${}</p>
      </div>
