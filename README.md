...
![Imagem do projeto](./assets/my-images/Lista-de-produtos-sem-seleção.png)

Imagem do projeto ao selecionar produtos
![Imagem do projeto](./assets/my-images/Lista-de-produtos-com-selecao.png)

Imagem do modal de confirmação de do pedido
![Imagem do projeto](./assets/my-images/Lista-de-produtos-com-modal.png)
